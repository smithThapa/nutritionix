        ...
        <div className="selected-item-container">
          {!isEmpty(selectedItem) ? (
            <div className="selected-item">
              <div className="selected-item-img">
                <div className="cancel-button">
                  <ClearIcon
                    ...
                    fontSize="large"
                    onClick={() => {
                      this.props.setSelectedItemActive(false);
                    }}
                  />
                </div>
              ...
              {selectedItem.nix_brand_id && (
                <div className="selected-item-brand-name">
              ...
              <div className="selected-item-serving-infos">
                ...
                <div className="selected-item-grams value-box">
                  <p className="selected-item-value">
                    {calculateConsumedGrams(
                      this.state.counter,
                      selectedItem.serving_qty,
                      selectedItem.serving_weight_grams
                    )}
                  </p>
            ...
            <div className="selected-item-circular">
              <div className="cancel-button-circular">
                <ClearIcon
                  className="clear-icon"
                  fontSize="large"
                  onClick={() => {
